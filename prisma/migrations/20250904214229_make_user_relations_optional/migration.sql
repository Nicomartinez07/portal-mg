...
INSERT INTO "new_Order" ("actualMileage", "additionalObservations", "companyId", "creationDate", "customerId", "diagnosis", "id", "internalStatus", "orderNumber", "status", "type", "userId", "vehicleVin") SELECT "actualMileage", "additionalObservations", "companyId", "creationDate", "customerId", "diagnosis", "id", "internalStatus", "orderNumber", "status", "type", "userId", "vehicleVin" FROM "Order";
DROP TABLE "Order";
...
INSERT INTO "new_Warranty" ("activationDate", "companyId", "customerId", "id", "userId", "vehicleVin") SELECT "activationDate", "companyId", "customerId", "id", "userId", "vehicleVin" FROM "Warranty";
DROP TABLE "Warranty";
