...
INSERT INTO "new_Order" ("actualMileage", "additionalObservations", "companyId", "creationDate", "customerId", "diagnosis", "draft", "id", "internalStatus", "orderNumber", "preAuthorizationNumber", "service", "status", "type", "userId", "vehicleVin") SELECT "actualMileage", "additionalObservations", "companyId", "creationDate", "customerId", "diagnosis", "draft", "id", "internalStatus", "orderNumber", "preAuthorizationNumber", "service", "status", "type", "userId", "vehicleVin" FROM "Order";
DROP TABLE "Order";
